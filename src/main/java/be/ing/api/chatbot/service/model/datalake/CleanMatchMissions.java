...
public class CleanMatchMissions   {
  ...
  public CleanMatchMissions active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanMatchMissions creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanMatchMissions deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanMatchMissions deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanMatchMissions deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanMatchMissions deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanMatchMissions deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanMatchMissions deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanMatchMissions entityId(String entityId) {
  ...
  **/
  ...
  public CleanMatchMissions extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanMatchMissions addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanMatchMissions lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanMatchMissions links(List<Link> links) {
    this.links = links;
    return this;
  }

  public CleanMatchMissions addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public CleanMatchMissions missions(List<Mission> missions) {
    this.missions = missions;
    return this;
  }

  public CleanMatchMissions addMissionsItem(Mission missionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanMatchMissions cleanMatchMissions = (CleanMatchMissions) o;
    return Objects.equals(this.active, cleanMatchMissions.active) &&
        Objects.equals(this.creationDate, cleanMatchMissions.creationDate) &&
        Objects.equals(this.deltaId, cleanMatchMissions.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanMatchMissions.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanMatchMissions.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanMatchMissions.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanMatchMissions.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanMatchMissions.deltaType) &&
        Objects.equals(this.entityId, cleanMatchMissions.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanMatchMissions.extraUnknownFields) &&
        Objects.equals(this.lastModified, cleanMatchMissions.lastModified) &&
        Objects.equals(this.links, cleanMatchMissions.links) &&
        Objects.equals(this.missions, cleanMatchMissions.missions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, lastModified, links, missions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanMatchMissions {\n");
