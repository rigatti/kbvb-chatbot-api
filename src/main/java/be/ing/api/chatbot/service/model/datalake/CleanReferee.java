...
public class CleanReferee   {
  ...
  public CleanReferee active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanReferee creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanReferee deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanReferee deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanReferee deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanReferee deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanReferee deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanReferee deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanReferee entityId(String entityId) {
  ...
  **/
  ...
  public CleanReferee extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanReferee addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanReferee id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public CleanReferee lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanReferee links(List<Link> links) {
    this.links = links;
    return this;
  }

  public CleanReferee addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanReferee cleanReferee = (CleanReferee) o;
    return Objects.equals(this.active, cleanReferee.active) &&
        Objects.equals(this.creationDate, cleanReferee.creationDate) &&
        Objects.equals(this.deltaId, cleanReferee.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanReferee.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanReferee.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanReferee.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanReferee.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanReferee.deltaType) &&
        Objects.equals(this.entityId, cleanReferee.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanReferee.extraUnknownFields) &&
        Objects.equals(this.id, cleanReferee.id) &&
        Objects.equals(this.lastModified, cleanReferee.lastModified) &&
        Objects.equals(this.links, cleanReferee.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, id, lastModified, links);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanReferee {\n");
