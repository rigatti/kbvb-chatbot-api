...
public class CleanDLKFansCampaigns   {
  ...
  public CleanDLKFansCampaigns active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanDLKFansCampaigns campaigns(List<Campaign> campaigns) {
    this.campaigns = campaigns;
    return this;
  }

  public CleanDLKFansCampaigns addCampaignsItem(Campaign campaignsItem) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns entityId(String entityId) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanDLKFansCampaigns addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanDLKFansCampaigns lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanDLKFansCampaigns cleanDLKFansCampaigns = (CleanDLKFansCampaigns) o;
    return Objects.equals(this.active, cleanDLKFansCampaigns.active) &&
        Objects.equals(this.campaigns, cleanDLKFansCampaigns.campaigns) &&
        Objects.equals(this.creationDate, cleanDLKFansCampaigns.creationDate) &&
        Objects.equals(this.deltaId, cleanDLKFansCampaigns.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanDLKFansCampaigns.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanDLKFansCampaigns.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanDLKFansCampaigns.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanDLKFansCampaigns.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanDLKFansCampaigns.deltaType) &&
        Objects.equals(this.entityId, cleanDLKFansCampaigns.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanDLKFansCampaigns.extraUnknownFields) &&
        Objects.equals(this.lastModified, cleanDLKFansCampaigns.lastModified);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, campaigns, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, lastModified);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanDLKFansCampaigns {\n");
