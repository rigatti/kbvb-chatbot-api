...
public class CleanPlayerTeam   {
  ...
  public CleanPlayerTeam active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanPlayerTeam creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanPlayerTeam deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanPlayerTeam deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanPlayerTeam deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanPlayerTeam deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanPlayerTeam deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanPlayerTeam deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanPlayerTeam entityId(String entityId) {
  ...
  **/
  ...
  public CleanPlayerTeam extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanPlayerTeam addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanPlayerTeam lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanPlayerTeam links(List<Link> links) {
    this.links = links;
    return this;
  }

  public CleanPlayerTeam addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public CleanPlayerTeam teams(List<Teams> teams) {
    this.teams = teams;
    return this;
  }

  public CleanPlayerTeam addTeamsItem(Teams teamsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanPlayerTeam cleanPlayerTeam = (CleanPlayerTeam) o;
    return Objects.equals(this.active, cleanPlayerTeam.active) &&
        Objects.equals(this.creationDate, cleanPlayerTeam.creationDate) &&
        Objects.equals(this.deltaId, cleanPlayerTeam.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanPlayerTeam.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanPlayerTeam.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanPlayerTeam.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanPlayerTeam.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanPlayerTeam.deltaType) &&
        Objects.equals(this.entityId, cleanPlayerTeam.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanPlayerTeam.extraUnknownFields) &&
        Objects.equals(this.lastModified, cleanPlayerTeam.lastModified) &&
        Objects.equals(this.links, cleanPlayerTeam.links) &&
        Objects.equals(this.teams, cleanPlayerTeam.teams);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, lastModified, links, teams);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanPlayerTeam {\n");
