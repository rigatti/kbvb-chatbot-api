...
public class CleanDLKFans   {
  ...
  public CleanDLKFans active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanDLKFans creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanDLKFans deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanDLKFans deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanDLKFans deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanDLKFans deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanDLKFans deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanDLKFans deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanDLKFans entityId(String entityId) {
  ...
  **/
  ...
  public CleanDLKFans extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanDLKFans addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanDLKFans fan(CleanDlkFan fan) {
    this.fan = fan;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public CleanDlkFan getFan() {
    return fan;
  }

  public void setFan(CleanDlkFan fan) {
    this.fan = fan;
  }

  public CleanDLKFans lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanDLKFans links(List<Link> links) {
    this.links = links;
    return this;
  }

  public CleanDLKFans addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanDLKFans cleanDLKFans = (CleanDLKFans) o;
    return Objects.equals(this.active, cleanDLKFans.active) &&
        Objects.equals(this.creationDate, cleanDLKFans.creationDate) &&
        Objects.equals(this.deltaId, cleanDLKFans.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanDLKFans.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanDLKFans.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanDLKFans.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanDLKFans.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanDLKFans.deltaType) &&
        Objects.equals(this.entityId, cleanDLKFans.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanDLKFans.extraUnknownFields) &&
        Objects.equals(this.fan, cleanDLKFans.fan) &&
        Objects.equals(this.lastModified, cleanDLKFans.lastModified) &&
        Objects.equals(this.links, cleanDLKFans.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, fan, lastModified, links);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanDLKFans {\n");
