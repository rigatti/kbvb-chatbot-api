...
public class CleanContacts   {
  ...
  private List<CleanContact> contacts = new ArrayList<CleanContact>();
  ...
  public CleanContacts active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanContacts contacts(List<CleanContact> contacts) {
    this.contacts = contacts;
    return this;
  }

  public CleanContacts addContactsItem(CleanContact contactsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<CleanContact> getContacts() {
    return contacts;
  }

  public void setContacts(List<CleanContact> contacts) {
    this.contacts = contacts;
  }

  public CleanContacts creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanContacts deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanContacts deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanContacts deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanContacts deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanContacts deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanContacts deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanContacts entityId(String entityId) {
  ...
  **/
  ...
  public CleanContacts extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanContacts addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanContacts lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanContacts links(List<Link> links) {
    this.links = links;
    return this;
  }

  public CleanContacts addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanContacts cleanContacts = (CleanContacts) o;
    return Objects.equals(this.active, cleanContacts.active) &&
        Objects.equals(this.contacts, cleanContacts.contacts) &&
        Objects.equals(this.creationDate, cleanContacts.creationDate) &&
        Objects.equals(this.deltaId, cleanContacts.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanContacts.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanContacts.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanContacts.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanContacts.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanContacts.deltaType) &&
        Objects.equals(this.entityId, cleanContacts.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanContacts.extraUnknownFields) &&
        Objects.equals(this.lastModified, cleanContacts.lastModified) &&
        Objects.equals(this.links, cleanContacts.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, contacts, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, lastModified, links);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanContacts {\n");
