...
public class CleanDLKFansProducts   {
  ...
  public CleanDLKFansProducts active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanDLKFansProducts creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanDLKFansProducts deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanDLKFansProducts deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanDLKFansProducts deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanDLKFansProducts deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanDLKFansProducts deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanDLKFansProducts deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanDLKFansProducts entityId(String entityId) {
  ...
  **/
  ...
  public CleanDLKFansProducts extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanDLKFansProducts addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanDLKFansProducts lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanDLKFansProducts products(List<Product> products) {
    this.products = products;
    return this;
  }

  public CleanDLKFansProducts addProductsItem(Product productsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanDLKFansProducts cleanDLKFansProducts = (CleanDLKFansProducts) o;
    return Objects.equals(this.active, cleanDLKFansProducts.active) &&
        Objects.equals(this.creationDate, cleanDLKFansProducts.creationDate) &&
        Objects.equals(this.deltaId, cleanDLKFansProducts.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanDLKFansProducts.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanDLKFansProducts.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanDLKFansProducts.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanDLKFansProducts.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanDLKFansProducts.deltaType) &&
        Objects.equals(this.entityId, cleanDLKFansProducts.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanDLKFansProducts.extraUnknownFields) &&
        Objects.equals(this.lastModified, cleanDLKFansProducts.lastModified) &&
        Objects.equals(this.products, cleanDLKFansProducts.products);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, lastModified, products);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanDLKFansProducts {\n");
