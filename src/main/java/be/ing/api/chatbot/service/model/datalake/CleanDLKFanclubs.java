...
public class CleanDLKFanclubs   {
  ...
  private FanClub fanclub = null;

  @SerializedName("lastModified")
  private LocalDateTime lastModified = null;

  public CleanDLKFanclubs active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanDLKFanclubs creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanDLKFanclubs deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanDLKFanclubs deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanDLKFanclubs deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanDLKFanclubs deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanDLKFanclubs deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanDLKFanclubs deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanDLKFanclubs entityId(String entityId) {
  ...
  **/
  ...
  public CleanDLKFanclubs extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanDLKFanclubs addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanDLKFanclubs fanclub(FanClub fanclub) {
  ...
  **/
  ...
  public CleanDLKFanclubs lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanDLKFanclubs cleanDLKFanclubs = (CleanDLKFanclubs) o;
    return Objects.equals(this.active, cleanDLKFanclubs.active) &&
        Objects.equals(this.creationDate, cleanDLKFanclubs.creationDate) &&
        Objects.equals(this.deltaId, cleanDLKFanclubs.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanDLKFanclubs.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanDLKFanclubs.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanDLKFanclubs.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanDLKFanclubs.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanDLKFanclubs.deltaType) &&
        Objects.equals(this.entityId, cleanDLKFanclubs.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanDLKFanclubs.extraUnknownFields) &&
        Objects.equals(this.fanclub, cleanDLKFanclubs.fanclub) &&
        Objects.equals(this.lastModified, cleanDLKFanclubs.lastModified);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, creationDate, deltaId, deltaObjectId, deltaOperation, deltaTimestamp, deltaTimestampDS, deltaType, entityId, extraUnknownFields, fanclub, lastModified);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CleanDLKFanclubs {\n");
    ...
    sb.append("    fanclub: ").append(toIndentedString(fanclub)).append("\n");
