...
public class CleanRefereeAvailabilities   {
  ...
  public CleanRefereeAvailabilities active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public CleanRefereeAvailabilities availabilities(List<Availability> availabilities) {
    this.availabilities = availabilities;
    return this;
  }

  public CleanRefereeAvailabilities addAvailabilitiesItem(Availability availabilitiesItem) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities creationDate(LocalDateTime creationDate) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities deltaId(String deltaId) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities deltaObjectId(String deltaObjectId) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities deltaOperation(Operation deltaOperation) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities deltaTimestamp(Long deltaTimestamp) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities deltaTimestampDS(Long deltaTimestampDS) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities deltaType(KbvbEntityType deltaType) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities entityId(String entityId) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities extraUnknownFields(List<UnknownObject> extraUnknownFields) {
    this.extraUnknownFields = extraUnknownFields;
    return this;
  }

  public CleanRefereeAvailabilities addExtraUnknownFieldsItem(UnknownObject extraUnknownFieldsItem) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities lastModified(LocalDateTime lastModified) {
  ...
  **/
  ...
  public CleanRefereeAvailabilities links(List<Link> links) {
    this.links = links;
    return this;
  }

  public CleanRefereeAvailabilities addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CleanRefereeAvailabilities cleanRefereeAvailabilities = (CleanRefereeAvailabilities) o;
    return Objects.equals(this.active, cleanRefereeAvailabilities.active) &&
        Objects.equals(this.availabilities, cleanRefereeAvailabilities.availabilities) &&
        Objects.equals(this.creationDate, cleanRefereeAvailabilities.creationDate) &&
        Objects.equals(this.deltaId, cleanRefereeAvailabilities.deltaId) &&
        Objects.equals(this.deltaObjectId, cleanRefereeAvailabilities.deltaObjectId) &&
        Objects.equals(this.deltaOperation, cleanRefereeAvailabilities.deltaOperation) &&
        Objects.equals(this.deltaTimestamp, cleanRefereeAvailabilities.deltaTimestamp) &&
        Objects.equals(this.deltaTimestampDS, cleanRefereeAvailabilities.deltaTimestampDS) &&
        Objects.equals(this.deltaType, cleanRefereeAvailabilities.deltaType) &&
        Objects.equals(this.entityId, cleanRefereeAvailabilities.entityId) &&
        Objects.equals(this.extraUnknownFields, cleanRefereeAvailabilities.extraUnknownFields) &&
        Objects.equals(this.lastModified, cleanRefereeAvailabilities.lastModified) &&
        Objects.equals(this.links, cleanRefereeAvailabilities.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class CleanRefereeAvailabilities {\n");
